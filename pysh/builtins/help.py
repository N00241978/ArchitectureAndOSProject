...
def builtin_help(args):
    print(f"{GREEN}  help - Show this help message{RESET}")
    print(f"  {BLUE}Available built-in commands:{RESET}")
    print(f"{GREEN}  pwd - Print the current working directory")
    ...
    print("  download <url> - Download a file from a URL")
